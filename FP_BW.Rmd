...
The Non-Pama-Nyungan languages show a similar pattern. Although here the clear majority does not have a dominant word order, the majoriy of those who do have one, will have one that starts their word order with the subject of the sentence. Opposing the Pama-Nyungan languages and their tendencies is the fact that here the amount of languages with a SOV word order outnumber those with a SVO order.
